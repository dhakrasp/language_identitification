...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', action='store', dest='train_path', default='langid-data-small/task2/train',
                        help='Path to training data')
    parser.add_argument('--dev_path', action='store', dest='dev_path', default='langid-data-small/task2/test',
